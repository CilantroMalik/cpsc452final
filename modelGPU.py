...
# load data
metacells = pd.read_csv("/home/rm2686/Documents/cpsc452/final/oligo-SCZ-metacellExpr.csv", index_col=0)
metadata = pd.read_csv("/home/rm2686/Documents/cpsc452/final/oligo-SCZ-meta.csv", index_col=0)
tom = pd.read_csv("/home/rm2686/Documents/cpsc452/final/oligo-SCZ-tom.csv", index_col=0)
...
con_samples = [metacells.columns.get_loc(c) for c in metadata[metadata["disorder_encoded"] == 1].sample(n=250).index.values]
scz_samples = [metacells.columns.get_loc(c) for c in metadata[metadata["disorder_encoded"] == 0].sample(n=250).index.values]

samples_train = con_samples[:200]
samples_train.extend(scz_samples[:200])
random.shuffle(samples_train)

samples_test = con_samples[200:]
samples_test.extend(scz_samples[250:])
...
torch.save(model, "/home/rm2686/Documents/cpsc452/final/modelOut.pth")
